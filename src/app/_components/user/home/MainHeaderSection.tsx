...
const MainHeaderSection = () => {
  ...
  return (
    <section className="flex h-[633px] w-full flex-col items-start justify-between bg-primary bg-home-bg bg-center bg-no-repeat object-cover px-40 pb-28 pt-36 text-sub-400">
